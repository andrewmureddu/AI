...
> **⟳ Extended 2026-07-29 by [D7](./D7-composition-lens.md): this floor is not
...
- A quantity Q can parameterize an equilibrium ensemble — appear in the
  ...
  > **⟳ Corrected 2026-07-29 by [D7](./D7-composition-lens.md): "iff it is
  ...
  > [D7 leg C](../experiments/D7-composition-lens/): additive statistics close
  ...
  > all: D7's test contains no dynamics and no group, so the criterion cannot
