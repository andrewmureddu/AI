# D7 — the lens under floor 1: composition, and what maintains it
...
[Leg C](../experiments/D7-composition-lens/) tilts six statistics of the same
...
[the audit](../experiments/D7-composition-lens/#6-leg-e2--the-audit), which is
...
- **Two registered predictions failed** in the run — leg C's growth exponent and
  ...
  [the experiment](../experiments/D7-composition-lens/), not buried here.
