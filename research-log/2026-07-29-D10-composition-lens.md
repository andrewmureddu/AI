# 2026-07-29 — D10: the lens under floor 1, and what maintains it

**Worked on:** [D10](../questions/UNKNOWN-LAWS.md) (new stone) ·
...
- **D10 stays N1.** The prior-art note's default was right and the run does not move
...
1. **The d ≥ 2 surface test — the cheapest thing with real teeth.** D10's
...
2. **Two indices on floor 3, no relation.** D6's q1/q2 classifies a singularity's
   shape; D10's failing order says what kind of failure being at one is. Is q1/q2
